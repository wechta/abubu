...
************************************************************************************************************/	
	...
	var form_widget_amount_slider_handle = 'res/cp2/images/slider_handle.gif';
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = "res/cp2/images/tab_right_active.gif"
					...
					img.src = "res/cp2/images/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = "res/cp2/images/tab_right_" + suffix + ".gif";
