...
$TYPO3_CONF_VARS['EXT']['extList'] = 'extbase,css_styled_content,info,perm,func,filelist,about,version,tsconfig_help,context_help,extra_page_cm_options,impexp,sys_note,tstemplate,tstemplate_ceditor,tstemplate_info,tstemplate_objbrowser,tstemplate_analyzer,func_wizards,wizard_crpages,wizard_sortpages,lowlevel,install,belog,beuser,aboutmodules,setup,taskcenter,info_pagetsconfig,viewpage,rtehtmlarea,t3skin,t3editor,reports,felogin,form,adodb,dbal,cshmanual,feedit,opendocs,recycler,scheduler,fluid,workspaces,rlmp_tmplselector,automaketemplate,kickstarter,phpmyadmin,tt_news,css_select,moderntab,doc_indexed_search,indexed_search,rgmediaimages,povprasevanje,dropdown_sitemap,api_macmade,pil_mailform,jb_gd_resize,realurl,seo_basics,easy_shop,footer,web_shop_registration,kenslider,iconepovezave,easycontact,dd_googlesitemap,dd_googlesitemap_dmf,jh_opengraph_ttnews,ke_dompdf,div2007,transactor,transactor_paymill,hubtie_sync';	// Modified or inserted by TYPO3 Extension Manager.  Modified or inserted by TYPO3 Core Update Manager.
...
$TYPO3_CONF_VARS['EXT']['extList_FE'] = 'extbase,css_styled_content,version,install,rtehtmlarea,t3skin,felogin,form,adodb,dbal,feedit,fluid,workspaces,rlmp_tmplselector,automaketemplate,kickstarter,phpmyadmin,tt_news,css_select,moderntab,doc_indexed_search,indexed_search,rgmediaimages,povprasevanje,dropdown_sitemap,api_macmade,pil_mailform,jb_gd_resize,realurl,seo_basics,easy_shop,footer,web_shop_registration,kenslider,iconepovezave,easycontact,dd_googlesitemap,dd_googlesitemap_dmf,jh_opengraph_ttnews,ke_dompdf,div2007,transactor,transactor_paymill,hubtie_sync';	// Modified or inserted by TYPO3 Extension Manager. 
